...
const mockjs_1 = (0, tslib_1.__importDefault)(require("mockjs"));
const path_1 = require("path");
const tiny_pinyin_1 = (0, tslib_1.__importDefault)(require("tiny-pinyin"));
const log_1 = (0, tslib_1.__importDefault)(require("./log"));
const index_1 = (0, tslib_1.__importDefault)(require("./openAPIParserMock/index"));
...
const mockGenerator = ({ openAPI, mockFolder, customGenerateList, mockPathPrefix, }) => (0, tslib_1.__awaiter)(void 0, void 0, void 0, function* () {
    const openAPParse = new index_1.default(openAPI, customGenerateList);
    ...
    Object.keys(mockActionsObj).forEach((file) => {
        ...
        (0, util_1.writeFile)(mockFolder, `${file}.mock.ts`, genMockFiles(mockActionsObj[file]));
    });
